// Напишите программу, которая на вход принимает позиции элементав двумерном массиве,
...
string PoiskElement(int[,] arr, int f, int s)
{
...
Console.WriteLine(PoiskElement(arr_1, first, second));
